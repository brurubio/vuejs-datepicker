...
var script = {
  ...
  methods: {
    ...
    getTypedDate: function getTypedDate(input) {
      var date = typeof this.formatTypedDate === 'function' ? this.formatTypedDate(input) : input;
      return date;
    }
  },
        ...
        directives: [
          {
            name: "mask",
            rawName: "v-mask",
            value: _vm.computedMask,
            expression: "computedMask"
          }
        ],
        ref: _vm.refName,
      ...
      _c(
        "date-input",
        {
          attrs: {
            ...
            "format-typed-date": _vm.formatTypedDate,
